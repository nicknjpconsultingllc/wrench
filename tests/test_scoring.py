...
class TestThroughputRetained:
    ...
    def test_near_zero_baseline_returns_none(self):
        # Denominator edge case (documented in wrench_core.scoring): a
...
def _fire_event(
    ...
    wrench_core.scoring._redundancy_total's docstring. Pass
    ...
    and the fork's tests/wrench/test_redundancy_grouping.py live regression tests for
